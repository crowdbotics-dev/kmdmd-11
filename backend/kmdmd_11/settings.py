"""
Django settings for kmdmd_11 project.
...
WSGI_APPLICATION = 'kmdmd_11.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kmdmd_11 API",
    "DESCRIPTION": "API documentation for kmdmd_11 App",
    "VERSION": "v1",
}
